  ...
  return (
    <div className="app-card p-6">
      ...
      <ul className="mt-4 space-y-3">
        {quotes.map((q) => (
          <li key={q} className="text-sm text-warm-600 leading-relaxed border-l-2 border-accent/40 pl-3">
            {q}
          </li>
        ))}
      </ul>
  ...
  return (
    <>
      ...
      <section className="mt-14">
        <h2 className="text-lg font-semibold tracking-tight text-ink mb-6">Health pillars</h2>
      ...
      <section className="mt-14">
        <h2 className="text-lg font-semibold tracking-tight text-ink mb-2">Friction concentration</h2>
      ...
      <section className="mt-14 grid gap-8 lg:grid-cols-2">
        <div>
          <h2 className="text-lg font-semibold tracking-tight text-ink mb-2">Recommended actions this quarter</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold tracking-tight text-ink mb-2">Benchmark context</h2>
